#!/usr/bin/env python3
"""
Thunderbird Autoencoder Anomaly Detection

Autoencoder for Thunderbird logs. Finds anomalies by reconstruction error.
...
class ThunderbirdAutoencoder:
    def __init__(self, data_path="Thunderbird_features.csv"):
        """Initialize the Thunderbird Autoencoder detector."""
        ...
        os.makedirs("thunderbird_autoencoder_results", exist_ok=True)
    ...
    def train_model(self, encoding_dim=64, epochs=100, batch_size=32):
        ...
        # Determine threshold (99th percentile of reconstruction error for very low anomaly rate)
    ...
    def plot_results(self):
        ...
        plt.tight_layout()
        plt.savefig('thunderbird_autoencoder_results/autoencoder_analysis.png', dpi=300, bbox_inches='tight')
        plt.close()
    ...
    def _plot_detailed_analysis(self):
        ...
        plt.tight_layout()
        plt.savefig('thunderbird_autoencoder_results/detailed_analysis.png', dpi=300, bbox_inches='tight')
        plt.close()
    ...
    def _plot_feature_reconstruction(self):
        ...
        plt.tight_layout()
        plt.savefig('thunderbird_autoencoder_results/feature_analysis.png', dpi=300, bbox_inches='tight')
        plt.close()
    ...
    def save_results(self):
        ...
        # Save model
        self.model.save('thunderbird_autoencoder_results/autoencoder_model.h5')
        
        # Save scalers
        joblib.dump(self.scaler, 'thunderbird_autoencoder_results/scaler.pkl')
        joblib.dump(self.autoencoder_scaler, 'thunderbird_autoencoder_results/autoencoder_scaler.pkl')
        ...
        summary_df.to_csv('thunderbird_autoencoder_results/model_summary.csv', index=False)
        
        # Save detailed results
        with open('thunderbird_autoencoder_results/detailed_results.txt', 'w') as f:
            f.write("Thunderbird Autoencoder Anomaly Detection Results\n")
            f.write("=" * 60 + "\n\n")
        ...
        logger.info("Results saved to thunderbird_autoencoder_results/ directory")
    
    def run_analysis(self, encoding_dim=64, epochs=100, batch_size=32):
        """Run the complete Autoencoder analysis."""
        logger.info("Starting Thunderbird Autoencoder Analysis")
        ...
        logger.info("Thunderbird Autoencoder analysis completed successfully!")
        
        return self.evaluation_results

def main():
    """Main function to run the analysis."""
    detector = ThunderbirdAutoencoder()
    results = detector.run_analysis()
    
    # Print summary
    print("\n" + "="*60)
    print("THUNDERBIRD AUTOENCODER RESULTS SUMMARY")
    print("="*60)
    ...
    print(f"\nResults saved in: thunderbird_autoencoder_results/")
